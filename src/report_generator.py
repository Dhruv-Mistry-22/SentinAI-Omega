...
def generate_pdf_report(
    ...
    if ai_results:
        ...
        for fname in sorted(files):
            ...
            pdf.cell(50, 6, f"Characteristics Score: {score}%")
            ...
            pdf.cell(100, 6, f"Assessment: {res['assessment']}")
            pdf.set_text_color(60, 60, 60)
            pdf.cell(40, 6, f"Confidence: {res['confidence']}", new_x="LMARGIN", new_y="NEXT")
            ...
            if verdict:
                ...
                pdf.cell(0, 5,
                    f"Verdict: {verdict}  |  AI-like paragraphs: {ai_pct:.1f}%  |  Mixed: {mixed_pct:.1f}%",
                    new_x="LMARGIN", new_y="NEXT")
